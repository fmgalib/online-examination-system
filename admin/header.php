...
<head>
    ...
    <title>Examinee Online Exam Management System</title>
...
<!--                <i class="fas fa-laugh-wink"></i>-->
            ...
            <li class="nav-item">
                <a class="nav-link" href="classes.php">
                    ...
                    <span style="font-size: 16px">Classes</span></a>
            </li>
            <li class="nav-item">
                ...
                <div id="subject_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="subject.php">Manage Courses</a>
                        <a class="collapse-item" href="assign_subject.php">Assign Courses</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#student_collapse" aria-expanded="false" aria-controls="student_collapse">
                    ...
                    <span style="font-size: 16px">Examinee</span>
                </a>
                <div id="student_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="student.php">Manage Examinee</a>
                        <a class="collapse-item" href="assign_student.php">Assign Examinee</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#exam_collapse" aria-expanded="false" aria-controls="exam_collapse">
                    ...
                    <span style="font-size: 16px">Exams</span>
                </a>
                <div id="exam_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="exam_subject.php">Exam Course</a>
<!--                        <a class="collapse-item" href="exam_subject_question.php">Questions</a>-->
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="user.php">
                    ...
                    <span style="font-size: 16px">Users</span></a>
            </li>
