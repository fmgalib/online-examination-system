                        ...
                        <div class="card-header bg-gradient-dark text-white py-3">
                        	<div class="row">
                            	...
                            	<div class="col" align="right">
                            		<button type="button" name="add_exam" id="add_exam" class="btn btn-success  btn-sm"><i class="fas fa-plus"></i> Add</button>
                            	</div>
                            </div>
                        </div>
                        <div class="card-body">
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
                ...
                exam_status_html += '<option value="Created">Created</option></select><span class="text-muted"><small>If you have select Created status, then Examinee will able to view Exam details in their dashboard & you will not able to edit or delete this exam data.</small></span>';
