...
//			$sub_array[] = $row["user_password"];
			...
			{
				$delete_button = '<button type="button" name="delete_button" class="btn btn-danger  btn-sm delete_button" data-id="'.$row["user_id"].'" data-status="'.$row["user_status"].'"><i class="fas fa-times"></i></button>';
				$status = '<button type="button" name="status_button" class="btn btn-primary btn-sm">Enable</button>';
			}
			else
			{
				$delete_button = '<button type="button" name="delete_button" class="btn btn-danger  btn-sm delete_button" data-id="'.$row["user_id"].'" data-status="'.$row["user_status"].'"><i class="fas fa-check"></i></button>';
