...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Assign Course</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-gradient-dark text-white py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold">Class List with Course</h6>
                            	</div>
                            	<div class="col" align="right">
                                    <button type="button" name="assign_subject" id="assign_subject" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Add</button>
                            	</div>
                            </div>
                        </div>
                        <div class="card-body">
...
$(document).ready(function(){
    ...
    $('#assign_subject').click(function(){
        ...
        $('#modal_title').text('Assign Course to Class');
