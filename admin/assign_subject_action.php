...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		foreach($result as $row)
		{
			...
			$sub_array[] = '
			<div align="center">
			<button type="button" name="edit_button" class="btn btn-warning  btn-sm edit_button" data-id="'.$row["subject_to_class_id"].'"><i class="fas fa-edit"></i></button>
			&nbsp;
			<button type="button" name="delete_button" class="btn btn-danger  btn-sm delete_button" data-id="'.$row["subject_to_class_id"].'"><i class="fas fa-times"></i></button>
			</div>
			';
			$data[] = $sub_array;
		}
	...
	if($_POST["action"] == 'Add')
	{
		...
		{
			$error = '<div class="alert alert-danger">Course Name Already Assign to <b>'.$object->Get_class_name($_POST["class_id"]).'</b> class</div>';
		}
		else
		{
			$data = array(
			...
			$success = '<div class="alert alert-success">Course Assign to <b>'.$object->Get_class_name($_POST["class_id"]).'</b> class</div>';
		}
	...
	if($_POST["action"] == 'Edit')
	{
		...
		else
		{
			...
			$success = '<div class="alert alert-success">Course Data Updated</div>';
		}
	...
	if($_POST["action"] == 'delete')
	{
		...
		echo '<div class="alert alert-success">Course Data Deleted</div>';
	}
