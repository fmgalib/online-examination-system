...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Exam Course Management</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-gradient-dark py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-white">Exam Course List</h6>
                            	</div>
                            	<div class="col" align="right">
                            		<button type="button" name="add_exam_subject" id="add_exam_subject" class="btn btn-success  btn-sm"><i class="fas fa-plus"></i> Add</button>
                            	</div>
                            </div>
                        </div>
                        <div class="card-body">
    	...
    	<form method="post" id="exam_subject_form">
      		<div class="modal-content">
        		<div class="modal-header bg-gradient-dark text-white">
          			<h4 class="modal-title" id="modal_title">Add Exam Course Data</h4>
...
$(document).ready(function(){
	...
	$('#add_exam_subject').click(function(){
    	...
    	$('#modal_title').text('Add Exam Course Data');
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
	        	...
	        	$('#modal_title').text('Edit Exam Course Data');
