...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		foreach($result as $row)
		{
			...
			$sub_array[] = '
			<div align="center">
			<button type="button" name="edit_button" class="btn btn-warning  btn-sm edit_button" data-id="'.$row["exam_subject_id"].'"><i class="fas fa-edit"></i></button>
			&nbsp;
	...
	if($_POST["action"] == 'Add')
	{
		...
		$success = '<div class="alert alert-success">Course Added in <b>'.$object->Get_exam_name($_POST["exam_id"]).'</b> Class</div>';
	...
	if($_POST["action"] == 'fetch_single')
	{
		...
		foreach($result as $row)
		{
			...
			$data['subject_select_box'] = '<option value="">Select Course</option><option value="'.$row['subject_id'].'">'.$object->Get_Course_name($row['subject_id']).'</option>';;
		}
	...
	if($_POST["action"] == 'Edit')
	{
		...
		$success = '<div class="alert alert-success">Exam Course Data Updated</div>';
	...
	if($_POST["action"] == 'delete')
	{
		...
		echo '<div class="alert alert-success">Exam Course Data Deleted</div>';
	}
}
