...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		foreach($result as $row)
		{
			...
			&nbsp;
			<button type="button" name="delete_button" class="btn btn-danger  btn-sm delete_button" data-id="'.$row["student_to_class_id"].'"><i class="fas fa-times"></i></button>
			</div>
			';
			$data[] = $sub_array;
		}
	...
	if($_POST["action"] == 'Add')
	{
		...
		else
		{
			...
			$success = '<div class="alert alert-success">Examinee Assign to <b>'.$object->Get_class_name($_POST["class_id"]).'</b> class</div>';
		}
	...
	if($_POST["action"] == 'Edit')
	{
		...
		else
		{
			...
			$success = '<div class="alert alert-success">Examinee Data Updated</div>';
		}
	...
	if($_POST["action"] == 'delete')
	{
		...
		echo '<div class="alert alert-success">Examinee Data Deleted</div>';
	}
