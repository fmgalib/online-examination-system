...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Assign Examinee Management</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-gradient-dark text-white py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold">Examinee List with Class Name</h6>
                            	</div>
                            	<div class="col" align="right">
                                    <button type="button" name="assign_student" id="assign_student" class="btn btn-success  btn-sm"><i class="fas fa-plus"></i> Add</button>
                            	</div>
                            </div>
                        </div>
                        <div class="card-body">
    	...
    	<form method="post" id="student_assign_form">
      		<div class="modal-content">
        		<div class="modal-header bg-gradient-dark text-white">
          			<h4 class="modal-title" id="modal_title">Assign Examinee to Class</h4>
...
$(document).ready(function(){
    ...
    $('#assign_student').click(function(){
        ...
        $('#modal_title').text('Assign Class to Examinee');
