...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
        ...
        WHERE exam_subject_question_soes.exam_id = '".$_POST["exam_id"]."'
		";
		$search_query = '';
...
//		$object->query = $main_query . $search_query . $order_query;
		...
		foreach($result as $row)
		{
            ...
            if ($row["exam_status"] == 'Completed'){
                ...
                $sub_array[] = '
			<div align="center">
			<button type="button" name="edit_button" class="btn btn-warning  btn-sm edit_button" data-id="'.$row["exam_subject_question_id"].'"><i class="fas fa-edit"></i></button>
			&nbsp;
			<button type="button" name="delete_button" class="btn btn-danger  btn-sm delete_button" data-id="'.$row["exam_subject_question_id"].'"><i class="fas fa-times"></i></button>
			</div>
			';
            }
	...
	if($_POST["action"] == 'Edit')
	{
		...
		$success = '<div class="alert alert-success">Exam Course Question Data Updated</div>';
	...
	if($_POST["action"] == 'delete')
	{
		...
		echo '<div class="alert alert-success">Exam Course Question Data Deleted</div>';
	}
}
