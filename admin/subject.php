...
?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header bg-gradient-dark text-white py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold">Course List</h6>
                            	</div>
                            	<div class="col" align="right">
                                    <button type="button" name="add_subject" id="add_subject" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Add</button>
                            	</div>
                            </div>
                        </div>
                        <div class="card-body">
