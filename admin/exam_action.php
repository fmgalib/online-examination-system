                ...
                else
                {
	                ...
	                else
	                {
	                	if($row['exam_status'] == 'Pending')
						{
							...
							$action_button = '
							<div align="center">
							<button type="button" name="edit_button" class="btn btn-warning  btn-sm edit_button" data-id="'.$row["exam_id"].'"><i class="fas fa-edit"></i></button>
							&nbsp;
							<button type="button" name="delete_button" class="btn btn-danger  btn-sm delete_button" data-id="'.$row["exam_id"].'"><i class="fas fa-times"></i></button>
							</div>
							';
						}
