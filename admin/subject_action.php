...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		foreach($result as $row)
		{
			...
			$sub_array[] = '
			<div align="center">
			<button type="button" name="edit_button" class="btn btn-warning  btn-sm edit_button" data-id="'.$row["subject_id"].'"><i class="fas fa-edit"></i></button>
			</div>
			';
			$data[] = $sub_array;
		}
	...
	if($_POST["action"] == 'Add')
	{
		...
		else
		{
			...
			$success = '<div class="alert alert-success">Course Added</div>';
		}
